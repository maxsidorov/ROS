...
class SetVelocity_Event(metaclass=Metaclass_SetVelocity_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<my_service_interfaces/SetVelocity_Request, 1>',
        'response': 'sequence<my_service_interfaces/SetVelocity_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_service_interfaces', 'srv'], 'SetVelocity_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['my_service_interfaces', 'srv'], 'SetVelocity_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from my_service_interfaces.srv import SetVelocity_Request
    ...
    def response(self, value):
        if self._check_fields:
            from my_service_interfaces.srv import SetVelocity_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetVelocity(metaclass=Metaclass_SetVelocity):
    ...
    from my_service_interfaces.srv._set_velocity import SetVelocity_Event as Event
